...
*--------------------------------------------------------*
   ...
   DEFINE WINDOW Form_1 ;
         AT 0, 0 ;
         WIDTH 378 HEIGHT 458 + GetBorderHeight() ;
         TITLE PROGRAM ;
         MAIN ;
         NOMAXIMIZE NOSIZE ;
...
RETURN AlertInfo( "Keyboard Control:;" + ;
      Repl( "-", 20 ) + ;
      ";;F2       - begin of the new game;" + ;
      "F3       - show of the Top 10;;" + ;
      "Ctrl+L - load of the preserved game;" + ;
      "Ctrl+S - save of the current game;;" + ;
      "Ctrl+P - pause/resume of the game;" + ;
      "Ctrl+Z - one move back of the game;" + ;
      "Ctrl+E - end of the game;" + ;
      "Ctrl+X - exit from the program", "Help", "MAIN", , , , ;
      {|| This.Say_01.Alignment := 'CENTER', ;
      This.Say_02.Alignment := 'CENTER', ;
      This.Btn_01.Col := (This.Btn_01.Col) - (This.Btn_01.Width)/1.3 } )

*--------------------------------------------------------*
FUNCTION MsgAbout() // About
*--------------------------------------------------------*

RETURN AlertInfo( PROGRAM + VERSION + " - FREEWARE;" + ;
      "Copyright " + Chr( 169 ) + COPYRIGHT + ;
      ";;eMail: gfilatov@inbox.ru;;" + ;
      "This program is Freeware!;" + ;
      "Copying is allowed!", "About", "MAIN", , , , ;
