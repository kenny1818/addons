...
If !Empty( oEditStru : aArray[ nRow, DBS_NAME ] )
   ...
   If ValType( oEditStru : aArray[ nRow, DBS_FLAG ] ) != "N"
      aStru := InitDefault()
      oEditStru : SetArray( aStru )
...
// Change the datas which are show in editing fields.
...
// Коригуємо співвідношення розмірності поля та дробної частини.
