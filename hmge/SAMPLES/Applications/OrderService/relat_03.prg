...
FUNCTION OS_tecnico_1()
   ...
   DEFINE WINDOW form_os_tecnico1 ;
         ...
         WIDTH 315 ;
         HEIGHT 220 ;
         TITLE 'Relatório: OS em Aberto (por técnico e período)' ;
         ICON 'icone' ;
         modal ;
         NOSIZE
...
STATIC FUNCTION cabecalho_os_periodo( pPagina, dData1, dData2 )
   ...
   @ 005, 010 PRINT 'RELAÇÃO DE ORDENS DE SERVIÇO ABERTAS - (Por TÉCNICO e por Período)' FONT 'courier new' SIZE 10 BOLD
