...
FUNCTION Main
   ...
   LOCAL width, height, enabled
   LOCAL frmTitle, btnCaption, chk1Caption, chk2Caption, chk3Caption, chk4Caption, lblCaption

   STATIC cSet1 AS GLOBAL VALUE 'QqWwEeRrTtYyUuIioPpAaSsDdFfGgHhJjKkLlZzXxCcVvBbNnMm-_'
   STATIC cSet2 AS GLOBAL VALUE '1234567890'
   ...
   DEFINE LABEL Label_2
      ROW 116
      COL GetProperty( 'Form_1', 'Spinner_1', 'Col' ) - ;
         GetTextWidth( , lblCaption, GetControlFontHandle( 'Spinner_1', 'Form_1' ) ) - 8
      VALUE lblCaption
      AUTOSIZE .T.
   END LABEL
...
PROCEDURE GenPass()
   ...
   CASE Form_1.Checkbox_3.Value .AND. Form_1.Checkbox_3.Enabled
      cSet := _SetGetGlobal( 'cSet1' )
   CASE Form_1.Checkbox_4.Value
      cSet := _SetGetGlobal( 'cSet2' )
   OTHERWISE
      cSet := _SetGetGlobal( 'cSet1' ) + _SetGetGlobal( 'cSet2' )
   ENDCASE
