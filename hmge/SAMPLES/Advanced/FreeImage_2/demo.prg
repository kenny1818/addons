...
// Image output areas are fixed sizes

// The coordinates of the image area from the file
...
// Coordinates of the image area from the resource
...
// Resource names (as defined by Demo.rc), although you can define
// your own and bind them in the boot procedure.
...
/******
*
*       Graphics output from file and resource
*
*/
...
Define window wMain                 ;
  ...
  Define main menu
    ...
    // !!! All menu items are associated with the name of the corresponding resource.
...
If IsNil( cFileImg )
   Return
Else
   nHandleFileImg := FI_Load( FI_GetFileType( cFileImg ), cFileImg, 0 )  // Loading the picture
Endif
...
*
*       Loading a picture from a resource
*
*/
...
*       ShowRes()
*
*       Derivation of a picture from a variable (resource loaded into memory)
*
*/
