...
FUNCTION fmenu()  // submenu or menu from key
   ...
   ELSE
      ...
      nszy := 30
   ENDIF
   _DefineModalWindow ( o_pm, ctitle, zkol, tss_zwie, ( zsze * 10 ) + 25, ( Len( ax ) * 25 ) + iif( hb_osisWin10(), 13, 5 ) + nszy + ncap + iif( isseven(), GetBorderHeight(), 0 ), "", .F., .F., .T., {, }, {, },, , , , ,, , , "MAIN", "ARIAL", 12,, , , , , , , , , , .F., , .F., .F., , , )
