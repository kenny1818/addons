...
static HICON MakeIcon_Numerical( DWORD dwFreeMemory, DWORD dwAvailMemory, BOOL bMemState, UINT glifOffset, UINT IconFont )
{
	HICON hIcon;
	ICONINFO ii;
	char szFree[32];
...
HB_FUNC( LOADNUMERICICON )
{
	...
	himage = ( HICON ) MakeIcon_Numerical( ( DWORD ) hb_parnl( 1 ), 
		( DWORD ) hb_parnl( 2 ), ( BOOL ) hb_parl( 3 ), ( INT ) hb_parni( 4 ), ( INT ) hb_parni( 5 ) ) ;
