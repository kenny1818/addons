...
#xtranslate ExternalApp.FILENAME         => "CALC.EXE"
#xtranslate ExternalApp.FULLFILENAME     => GetSystemDir()+"\"+ExternalApp.FILENAME
...
FUNCTION Main()
	...
	DEFINE WINDOW Form_Main ;
		...
		DEFINE BUTTON Button_3
			...
			COL	10
			WIDTH	150
			CAPTION 'Set New Row of Calc' 
			ACTION iif (ExternalApp.IsOpen == .T., ExternalApp.ROW := Form_Main.ROW - 250, NIL)
		END BUTTON
		...
		DEFINE BUTTON Button_4
			...
			COL	10
			WIDTH	150
			CAPTION 'Set New Column of Calc' 
			ACTION iif (ExternalApp.IsOpen == .T., ExternalApp.COL := Form_Main.COL - 250, NIL)
		END BUTTON
