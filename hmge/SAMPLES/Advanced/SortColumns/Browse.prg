/*
 * ListView SORT ORDER COLUMN Demo
 *
 */
...
LOCAL aWidths := { 100 , 150 , 150 , 150 , 150 , 150 }
	...
	DEFINE WINDOW Form_1 ;
		...
		DEFINE MAIN MENU 
			POPUP 'File'
				...
				ITEM 'Get Columns Width'	ACTION MsgDebug ( GetColumnsWidths( "Browse_1", "Form_1", aColumns ) )
	...
	ListView_SetColumnOrderArray( Form_1.Browse_1.Handle, Form_1.Browse_1.ColumnCOUNT, aColumns )
...
LOCAL aColumns := ListView_GetColumnOrderArray( Form_1.Browse_1.Handle, Form_1.Browse_1.ColumnCOUNT ), i
	...
	BEGIN INI FILE 'test.ini'
		...
		SET SECTION "Columns" ENTRY "Widths" TO GetColumnsWidths( "Browse_1", "Form_1", aColumns )
...
LOCAL aDbf[6][4], i
	...
	For i = 1 To 200
		Append Blank
		Replace code with i 
		Replace First With 'First Name '+ hb_ntos(i)
		Replace Last With 'Last Name '+ hb_ntos(i)
...
*--------------------------------------------------------------------
Function GetColumnsWidths( ControlName , ParentForm , aColumns )
*--------------------------------------------------------------------
