 ...
 *
 * Demo was contributed to HMG forum by Edward 03/Dec/2018
 *
...
SELECT HPDFDOC "sample2.pdf" PAPERLENGTH 300 PAPERWIDTH 300
...
START HPDFDOC
	...
	START HPDFPAGE
		...
		//Adjust the height of the text of the area and get the bottom row using a variable by reference
		@ nNextRow, 15 HPDFPRINT "Some short text ABC O xyz" TO nNextRow, 185 FONT cFonte1 size 8 HEIGHTFIT GETBOTTOM @nBottomRow
		@ nNextRow, 15 HPDFPRINT RECTANGLE TO nBottomRow, 185 PENWIDTH 0.1

		nNextRow := nBottomRow + 1
		
		//Calculate the text height of the area.
		nHeight := _HMG_HPDF_GetHeight_MULTILINE_PRINT ( "Some short text ABC O xyz" /* cText */ , 185 - 15 /* nLen ( nToCol - nCol ) */ , cFonte1 /* cFontName */, 8 /* nFontSize */, .T. /* lBold */, /* lItalic */ , /* lWrap */ )	
		//Print and draw area with calculated height.
		@ nNextRow, 15 HPDFPRINT RECTANGLE TO nNextRow + nHeight , 185 PENWIDTH 0.1
		@ nNextRow, 15 HPDFPRINT "Some short text ABC O xyz" TO nNextRow + nHeight, 185 FONT cFonte1 size 8 BOLD
		...
		@ nBottomRow + 2, 15 HPDFPRINT "Last Row := " + hb_ntos(nBottomRow) + " mm" SIZE 6
		
	END HPDFPAGE
END HPDFDOC

Execute File 'sample2.pdf'
