...
*--------------------------------------------------------*
   ...
   // Copy a database and index to the disk files
   hb_vfCopyFile( "mem:test.dbf", "test.dbf" ) 
   hb_vfCopyFile( "mem:test.cdx", "test.cdx" ) 
...
*--------------------------------------------------------*
   ...
   DBCREATE("mem:test", {{"CODE", "C", 3, 0},{"NAME", "C", 50, 0},{"RESIDENTS", "N", 11, 0}}, "DBFCDX", .T., "memarea")
