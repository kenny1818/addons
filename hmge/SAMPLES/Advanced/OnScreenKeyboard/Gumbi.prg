...
*                                                                        *
* Copyright 2003-16 Grigory Filatov <gfilatov@inbox.ru>                  *
*                                                                        *
* Modificated 1.1.2017 by                                                *
...
*------------------------------------------------------------*
     ...
     nCRLF := CountIt( _HMG_aControlCaption[ i ] ) + 1  // ÈE SO DVE VRSTICI
     ...
     ELSEIF ! ( _HMG_aControlRangeMax[ i ][ 1 ] == 1 )   // normal
          IF  aButStyles[ iButStyle, 2 ] > 0
               ...
               //                  barv:=getproperty("Form_2_x","backcolor")
               //                 OnPaint(hWnd,-4,-4, aBtnRc[ 3 ]+7,aBtnRc[ 4 ]+7, barv[1],barv[2],barv[3] , _HMG_aControlBkColor[ i, 1 ], _HMG_aControlBkColor[ i, 2 ], _HMG_aControlBkColor[ i, 3 ]   , 5)
               ...
               ELSEIF aButStyles[ iButStyle, 2 ] = 5  // Type fill grag vert 2
                    FillGradient( hDC, aBtnRc[ 2 ], aBtnRc[ 1 ], aBtnRc[ 4 ] / 2, aBtnRc[ 3 ], .T. ,  rgb (_HMG_aControlBkColor[ i, 1 ], _HMG_aControlBkColor[ i, 2 ],_HMG_aControlBkColor[ i, 3 ]) ,;
                         RGB( aFill2[ 1 ], aFill2[ 2 ], aFill2[ 3 ] ))
                    FillGradient( hDC, aBtnRc[ 4 ] / 2, aBtnRc[ 1 ], aBtnRc[ 4 ], aBtnRc[ 3 ], .T. , RGB( aFill2[ 1 ], aFill2[ 2 ], aFill2[ 3 ] ) ,;
                         rgb (_HMG_aControlBkColor[ i, 1 ], _HMG_aControlBkColor[ i, 2 ],_HMG_aControlBkColor[ i, 3 ]) )

               ELSEIF aButStyles[ iButStyle, 2 ] = 6  // Type fill grag vert 2
                    FillGradient( hDC, aBtnRc[ 2 ], aBtnRc[ 1 ], aBtnRc[ 4 ], aBtnRc[ 3 ] / 2, .F., rgb (_HMG_aControlBkColor[ i, 1 ], _HMG_aControlBkColor[ i, 2 ],_HMG_aControlBkColor[ i, 3 ]),;
                         RGB( aFill2[ 1 ], aFill2[ 2 ], aFill2[ 3 ] )  )
                    FillGradient( hDC, aBtnRc[ 2 ], aBtnRc[ 3 ] / 2, aBtnRc[ 4 ], aBtnRc[ 3 ], .F., RGB( aFill2[ 1 ], aFill2[ 2 ], aFill2[ 3 ] ),;
                         rgb (_HMG_aControlBkColor[ i, 1 ], _HMG_aControlBkColor[ i, 2 ],_HMG_aControlBkColor[ i, 3 ])  )
               ELSEIF aButStyles[ iButStyle, 2 ] = 10  // Type fill grag vert 2
          ...
          IF aButStyles[ iButStyle, 9 ] = 1
               rectdraw( hWnd, aBtnRc[ 1 ] , aBtnRc[ 2 ] , aBtnRc[ 4 ] , aBtnRc[ 3 ] , aButStyles[ iButStyle, 10 ], 1, BELA_BARVA, .F. )
          ELSEIF aButStyles[ iButStyle, 9 ] = 2
               roundrectdraw( hWnd, aBtnRc[ 1 ] , aBtnRc[ 2 ] , aBtnRc[ 4 ] , aBtnRc[ 3 ] , 8, 8, aButStyles[ iButStyle, 10 ], 1, BELA_BARVA, .F. )
          ELSEIF aButStyles[ iButStyle, 9 ] = 3
               rectdraw( hWnd, aBtnRc[ 1 ] , aBtnRc[ 2 ] , aBtnRc[ 4 ] , aBtnRc[ 3 ] , { _HMG_aControlBkColor[ i, 1 ], _HMG_aControlBkColor[ i, 2 ],_HMG_aControlBkColor[ i, 3 ]}, 1, BELA_BARVA, .F. )
          ELSEIF aButStyles[ iButStyle, 9 ] = 10
               rectdraw( hWnd, aBtnRc[ 1 ] , aBtnRc[ 2 ] , aBtnRc[ 4 ] , aBtnRc[ 3 ] , { _HMG_aControlBkColor[ i, 1 ], _HMG_aControlBkColor[ i, 2 ],_HMG_aControlBkColor[ i, 3 ]}, 1, BELA_BARVA, .F. )
          ELSEIF aButStyles[ iButStyle, 9 ] = 11
               //               rectdraw( hWnd, aBtnRc[ 1 ] , aBtnRc[ 2 ] , aBtnRc[ 4 ] , aBtnRc[ 3 ] , { _HMG_aControlBkColor[ i, 1 ], _HMG_aControlBkColor[ i, 2 ],_HMG_aControlBkColor[ i, 3 ]}, 1, BELA_BARVA, .F. )
     ...
     ELSE                                           // over
          ...
          IF aButStyles[ iButStyle, 9 ] = 1
               rectdraw( hWnd, aBtnRc[ 1 ] , aBtnRc[ 2 ] , aBtnRc[ 4 ] , aBtnRc[ 3 ] , aButStyles[ iButStyle, 11 ], 1, BELA_BARVA, .F. )
          ELSEIF aButStyles[ iButStyle, 9 ] = 2
               roundrectdraw( hWnd, aBtnRc[ 1 ] , aBtnRc[ 2 ] , aBtnRc[ 4 ] , aBtnRc[ 3 ] , 8, 8, aButStyles[ iButStyle, 11 ], 1, BELA_BARVA, .F. )
          ELSEIF aButStyles[ iButStyle, 9 ] = 3
               rectdraw( hWnd, aBtnRc[ 1 ] , aBtnRc[ 2 ] , aBtnRc[ 4 ] , aBtnRc[ 3 ] , { _HMG_aControlBkColor[ i, 1 ], _HMG_aControlBkColor[ i, 2 ],_HMG_aControlBkColor[ i, 3 ] }, 1, BELA_BARVA, .F. )
          ELSEIF aButStyles[ iButStyle, 9 ] = 10
               rectdraw( hWnd, aBtnRc[ 1 ]  , aBtnRc[ 2 ] , aBtnRc[ 4 ] , aBtnRc[ 3 ] , { _HMG_aControlBkColor[ i, 1 ], _HMG_aControlBkColor[ i, 2 ],_HMG_aControlBkColor[ i, 3 ] }, 2, BELA_BARVA, .F. )
          ELSEIF aButStyles[ iButStyle, 9 ] = 11
               //               rectdraw( hWnd, aBtnRc[ 1 ] +1 , aBtnRc[ 2 ] +1, aBtnRc[ 4 ] , aBtnRc[ 3 ] , { _HMG_aControlBkColor[ i, 1 ], _HMG_aControlBkColor[ i, 2 ],_HMG_aControlBkColor[ i, 3 ] }, 2, BELA_BARVA, .F. )
               //                  barv:=getproperty("Form_2_x","backcolor")
               //                 OnPaint(hWnd,-5,-5, aBtnRc[ 3 ]+10,aBtnRc[ 4 ]+10, barv[1],barv[2],barv[3] , _HMG_aControlBkColor[ i, 1 ], _HMG_aControlBkColor[ i, 2 ], _HMG_aControlBkColor[ i, 3 ]   , 5)
          ENDIF
