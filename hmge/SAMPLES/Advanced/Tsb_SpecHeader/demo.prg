...
FUNCTION OpenTable(met)
  ...
  ELSE
    ...
    Index On Employee->First+Employee->Last To First   // NTX
    Index On Employee->City To City                    // NTX
    Set Index To State, First, City                    // NTX
    ...
    DEFINE WINDOW Form_SQL ;
      ...
      DO CASE
        ...
        CASE nVer == 3
          ...
          @ 470, 40 LABEL Lb2 VALUE "Try filtering on any piece of text, for example enter '%OO' in SpecHeader of Colunm 'Last' " ;
            WIDTH 500 HEIGHT 40
