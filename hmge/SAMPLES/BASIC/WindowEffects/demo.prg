...
FUNCTION Main
   ...
   DEFINE WINDOW Win_1 ;
      ...
      @ 80, 10 EDITBOX EDIT_1 ;
         VALUE 'Select the effect to apply to the window and then open and close the window and see the effect is maintained for both events' ;
         WIDTH 360 HEIGHT 150 NOHSCROLL
