...
PROCEDURE Create_NOTIFY_Menu ()
   ...
   IF IsNotifyMenuDefined (ThisWindow.Name) == .T.
...
PROCEDURE Release_NOTIFY_Menu ()
   ...
   IF IsNotifyMenuDefined (ThisWindow.Name) == .F.
...
PROCEDURE Create_CONTEXT_Menu ()
   ...
   IF IsContextMenuDefined (ThisWindow.Name) == .T.
...
PROCEDURE Release_CONTEXT_Menu ()
   ...
   IF IsContextMenuDefined (ThisWindow.Name) == .F.
