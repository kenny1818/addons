...
*/
      ...
      @ 250,10 BUTTON Button_7 ;
         ...
         ACTION MsgInfo( "Spinner_2 Increment: " + hb_NToS( Form_Main.Spinner_2.Increment ) + CRLF + ;
                         ...
                         "Spinner_2 Wrap style: " + cValToChar( IsWindowHasStyle ( Form_Main.Spinner_2.Handle [2], UDS_WRAP ) ) + CRLF + ;
                         "Spinner_2 Horizontal style: " + cValToChar( IsWindowHasStyle ( Form_Main.Spinner_2.Handle [2], UDS_HORZ ) ) )
