    ...
    SET CELLNAVIGATIONMODE VERTICAL
        ...
        DEFINE WINDOW Form_1 ;
           ...
           @ 10,10 GRID Grid_1 ;
                ...
                ITEMS aRows ;
                EDIT ;
                INPLACE { {}, { 'DYNAMIC', bBlock ,{|v|MsgInfo(v)}}, { 'DYNAMIC', bBlock ,{|v|MsgInfo(v)} }} ;
                COLUMNWHEN {{||.F.},{||.T.},{||.T.}} ;
                CELLNAVIGATION ;
                VALUE {1, 2}
...
LOCAL aRet
   ...
   IF r == 3 .AND. c == 2 
      aRet:={"CODEBLOCK",{|v|FalseTrue(v)},{|v|MsgInfo(v)}}
   ELSEIF r == 7 .AND. c == 2 
      aRet:={"CODEBLOCK",{|v|Getfont(v)[1]},{|v|MsgInfo(v)}}
   ELSEIF c == 2 .AND. r >= 1 .AND. r <= LEN(aEdit)
      aRet:=aEdit[r]
   ELSE
