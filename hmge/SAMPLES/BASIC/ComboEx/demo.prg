     ...
     DEFINE MAIN MENU
         ...
         END POPUP
          ...
          // set new tooltip for combo
            ...
            MENUITEM 'Set new tooltip for ComboEx_3' ACTION {|| (Form_1.ComboEx_3.Tooltip:='New tooltip exCombo3')}
      ...
      // 3rd extend COMBO
         ...
         @ 133,10 Label Label_3ex Value "Extend ComboEx_3 - Edit" AUTOSIZE
           ...
           @ 160,10 COMBOBOXEX ComboEx_4 ;
              WIDTH 530 ;
              ITEMS {"http://hmgextended.com","http://harbourminigui.blogspot.com","https://harbour.github.io","http://groups.yahoo.com/group/harbourminigui"} ;
              VALUE 1 ;
              DISPLAYEDIT;
