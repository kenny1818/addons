...
function Form_Main_OnPaint( hWnd, hIcon, w, h )
   ...
   nColor = C_SetBackColor( hWnd, RGB( 250, 0, 0 ) )
   // nColor = C_SetBackColor( hWnd, 250, 0, 0 )
   // nColor = C_SetBackColor( hWnd, { 250, 0, 0 } )
   ...
   C_SetBackColor( hWnd, nColor )
   // C_SetBackColor( hWnd, GetRed( nColor ), GetGreen( nColor ), GetBlue( nColor ) )
   // C_SetBackColor( hWnd, { GetRed( nColor ), GetGreen( nColor ), GetBlue( nColor ) } )
