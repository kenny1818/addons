...
Function Main
    ...
    DEFINE WINDOW Form_1 ;
           ...
           DEFINE STATUSBAR
                  STATUSITEM ' HMG Power Ready!'+ chr(9)+chr(9)+"Press F10 to switch Button 1 or F2 for Info    "
           END STATUSBAR
...
*-----------------------------------------------------------------------------*
    ...
    DEFINE WINDOW Form_2 ;
           ...
           DEFINE STATUSBAR
                  STATUSITEM ' HMG Power Ready!'+ chr(9)+chr(9)+"Press F10 or F2 for Info  "
           END STATUSBAR
...
*-----------------------------------------------------------------------------*
Procedure TB_ReplacePictureClick
*-----------------------------------------------------------------------------*
STATIC i := 1
   ...
   DO CASE
      ...
      CASE i == 2
         ...
         Form_1.Button_1.Action  :=  {||Msgbox([New Action "TWO" for Button 1],"TWO")}

      CASE i == 3
         Form_1.Button_1.Caption := 'THREE'
         Form_1.Button_1.Picture := 'button3.bmp'
         Form_1.Button_1.Action  :=  {||Msgbox([New Action "THREE" for Button 1],"THREE")}
