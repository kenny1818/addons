...
Function Main
   ...
   DEFINE WINDOW Form_1 ;
      ...
      @ 50,10 GRID Grid_1 ;
         ...
         COLUMNWHEN  { {||.F.}, {||.F.}, {|| .T. } };
         COLUMNVALID { NIL    , NIL    , {|| ChangeGroup() } };
         VALUE 1; 
         EDIT;
         CELLNAVIGATION
...
*/
      ...
      FOR i := 1 TO Form_1.Grid_1.ItemCount
         ...
         IF i <= Form_1.Grid_1.ItemCount / 2
            ...
            Form_1.Grid_1.Cell (i, 3)     := 2   // Unconfirmed
         ELSE
            Form_1.Grid_1.GroupItemID (i) := GROUP1_ID
            Form_1.Grid_1.Cell (i, 3)     := 1   // Confirmed
         ENDIF
...
FUNCTION ChangeGroup
   LOCAL Row := This.CellRowIndex
   LOCAL Col := This.CellColIndex

   IF This.CellValue <> Form_1.Grid_1.Cell ( Row, Col )

      IF This.CellValue == 1
         Form_1.Grid_1.GroupItemID ( Row ) := GROUP1_ID   // Confirmed
      ELSE
         Form_1.Grid_1.GroupItemID ( Row ) := GROUP2_ID   // UnConfirmed
      ENDIF
...
PROCEDURE GetListConfirmed
   ...
   FOR i = 1 TO Form_1.Grid_1.ItemCount
      ...
      IF Form_1.Grid_1.GroupItemID ( i ) == GROUP1_ID
         cList := cList + Form_1.Grid_1.Cell (i, 1) + ", " + Form_1.Grid_1.Cell (i, 2) + CRLF
      ENDIF
