/*
   ...
   April  2018 :
   Modified : Retrieve the image sizes from an application's resource
*/
...
PROCEDURE CheckUser()  
    ...
    LOCAL cPictRes := "FoldLock", nPicWidth, nPicHeight, aPicBackColor := FUCHSIA

    IF GetImageInfo( cPictRes, @nPicWidth, @nPicHeight )
	    ...
	    ON KEY ESCAPE ACTION ThisWindow.Release
            ...
            @ 0, 0 IMAGE Image_1 PICTURE cPictRes 
    ...
    ELSE
        MsgStop( cPictRes + " image resource open error ! Program aborted !", "ERROR !" )
    ENDIF
