...
Local cMessage:=Space(250), cFrom:=Space(30), nValidity:=10
   ...
   DEFINE WINDOW _NewForm   ;
      ...
      @ 5, 10 LABEL _Label_1 VALUE "Texto del Mensaje" WIDTH 270 HEIGHT 18 TRANSPARENT
...
Local n, aRect := Array(4)
	...
	START DOC NAME cTitle
		...
		START PAGE
			...
			@1, 1+(HBPRNMAXCOL-Len(cTitle))/2 SAY cTitle FONT "Font_1" COLOR CLR_BLUE_ TO PRINT
