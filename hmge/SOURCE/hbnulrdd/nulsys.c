...
HB_FUNC( ORDKEYCOUNT ) { hb_retni( 0 ); }

HB_FUNC( ORDKEYNO ) { hb_retni( 0 ); }

HB_FUNC( ORDSETFOCUS ) { hb_parni( 0 ); }

HB_FUNC( ORDNUMBER ) { hb_retni( 0 ); }

HB_FUNC( ORDLISTCLEAR ) {}

HB_FUNC( ORDCONDSET ) { hb_retl( HB_FALSE ); }

HB_FUNC( ORDCREATE ) {}

HB_FUNC( ORDDESCEND ) { hb_parni( 1 ); }

HB_FUNC( ORDKEYVAL ) { hb_retc_null(); }

HB_FUNC( DBINFO ) { hb_parni( 1 ); }

HB_FUNC( DBRUNLOCK ) {}

HB_FUNC( DBCOMMIT ) {}

HB_FUNC( DBRLOCKLIST ) { hb_reta( 0 ); }