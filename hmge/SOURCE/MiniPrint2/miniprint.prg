...
Local icb
	...
	DEFINE WINDOW _HMG_PRINTER_PPNAV ;
			AT 0,0 ;
			WIDTH GetDesktopWidth() - 103 - IF ( _SetGetGlobal( "IsVistaThemed" ) , 25 , 0);
			HEIGHT GetDesktopHeight() - 66 - IF ( _SetGetGlobal( "IsVistaThemed" ) , 25 , 0);
		...
		DEFINE WINDOW _HMG_PRINTER_SHOWPREVIEW ;
			WIDTH GetDesktopWidth() - 103 - IF ( _SetGetGlobal( "IsVistaThemed" ) , 25 , 0);
			HEIGHT GetDesktopHeight() - 140  - IF ( _SetGetGlobal( "IsVistaThemed" ) , 25 , 0);
...
*------------------------------------------------------------------------------*
	...
	If _HMG_PRINTER_PPNAV.thumbswitch.Value == .T.
		...
		_HMG_PRINTER_PPNAV.Width := GetDesktopWidth() - 148 - IF ( _SetGetGlobal( "IsVistaThemed" ) , 30 , 0 )

		_HMG_PRINTER_PPNAV.Col := 138 + IF ( _SetGetGlobal( "IsVistaThemed" ) , 20 , 0 )
...
HB_FUNC( _HMG_PRINTER_STARTPAGE_PREVIEW )
{
   ...
   tmpDC = CreateEnhMetaFile( ( HDC ) HB_PARNL( 1 ), FileName, &emfrect, TEXT( "" ) );
