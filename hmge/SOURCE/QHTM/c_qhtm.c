...
typedef void ( WINAPI * QHTM_PRINTDESTROYCONTEXT )( QHTMCONTEXT ctx );
...
HB_FUNC( QHTM_PRINTDESTROYCONTEXT )
{
   if( hQhtmDll )
   {
      QHTM_PRINTDESTROYCONTEXT pFunc = ( QHTM_PRINTDESTROYCONTEXT ) wapi_GetProcAddress( hQhtmDll, "QHTM_PrintDestroyContext" );
