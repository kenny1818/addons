...
*-----------------------------------------------------------------------------*
   ...
   CASE T == "DATEPICK"
      ...
      IF Empty ( _SetGetDatePickerDateFormat ( _HMG_aControlNames [ix] , GetParentFormName( ix ) ) )
...
*-----------------------------------------------------------------------------*
   ...
   CASE 4 // PCount() == 4 (CONTROL)
      ...
      CASE Arg3 == "FONTCOLOR" .OR. Arg3 == "FORECOLOR" .OR. Arg3 == "CELLNAVIGATION"
...
*-----------------------------------------------------------------------------*
   ...
   OTHERWISE
      _HMG_aControlFontColor [i] := Value
      IF t == 'GRID'
         _HMG_aControlMiscData1 [i] [ 1 ] := LISTVIEW_GETFOCUSEDITEM ( _HMG_aControlHandles [i] )
      ENDIF
      _RedrawControl ( i )
